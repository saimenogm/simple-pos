                                        ...
                                        <table id="myTable1" name="test[]" class="tab-content"
                                            ...
                                            <tr id="clone_row">
                                                ...
                                                <td id='color_col'>
                                                    ...
                                                    <select class="form-control " id="color" name="varity_route[]">

                                                        <option></option>' +
                                                        '<option value="Tablet">Tablet</option><option value="Injectable">Injectable</option><option value="Wrap">Wrap</option><option value="Syrup">Syrup</option></select>
                                                    </select>
                                                ...
                                                <TD><INPUT type="text" class="form-control "
                                                           name="varity_dosage[]"
                                                           id="other_attributes_variant"/>
                                                </TD>
                                                <TD id='size_col'><select class="form-control " id="size" name="uom[]">
                                                        <option></option>
                                                        <option value="mg">mg</option>
                                                        <option value="ml">ml</option>                                                    </select>
                                                </TD>

                                                <TD id='uod'><select class="form-control " id="uod" name="varity_uod[]">
                                                        <option></option><option value="Box">Box</option><option value="Strip">Strip</option><option value="Bottle">Bottle</option><option value="PCs">PCs</option>                                                  </select>
                                                </TD>
...
// remove from check
                    ...
                    <script>
                        ...
                        function insRow(id) {
                            ...
                            a.innerHTML = n;
                            b.innerHTML = '<INPUT type="text" class="form-control" name="other_attributes_variant[]" />';
                            c.innerHTML = m;
                            bb.innerHTML= aa;
