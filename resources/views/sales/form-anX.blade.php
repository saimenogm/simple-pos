...
<td class="table_details">
    <select name="freq" class="table_details" style="font-size:12px; padding-left:-3px; margin-left:-3px;" v-model="sale.freq" id="freq_{{$index}}">
...
<input type="text" style="margin:0px; padding:0px;" name="dosage" v-model="sale.dosage" id="dosage_{{$index}}" width=20 size=20>
</div>

<div class="col-md-5" style="width:40%; margin:0px;margin-left: -7px; margin-right:-10px; padding-right:0px; padding-left:0px;">
<select name="uom" id="uom_{{$index}}" v-model="sale.uom">
...
<div class="col-md-7">
  <input type="text" width=13 size=20 name="duration" id="duration_{{$index}}"  v-model="sale.duration">
</div>

<div class="col-md-5" style="width:40%; margin:0px;margin-left: -20px; margin-right:-40px; padding-right:0px; padding-left:0px;" >
<select name="uod" id="uod_{{$index}}" v-model="sale.duration_length">
...
<td>
    ...
    <select name="route" id="route_{{$index}}" v-model="sale.route">
    ...
    <option value="other">Other</option>
            ...
            <td><input type="text" value="{{ x.qty }}"  name="qty" /></td>
            <td>{{ x.unit_price }} </td>
            <td>{{ x.sub_total}} </td>
