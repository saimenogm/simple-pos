...
<html>
    <head>
        ...
        <link href="{{ asset('libs/prettify/github.css')}}" rel="stylesheet" />
                ...
                <link href="{{ asset('libs/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/jquery-clock/clock.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/bootstrap-calendar/css/bic_calendar.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/sortable/sortable-theme-bootstrap.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/jquery-weather/simpleweather.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/bootstrap-xeditable/css/bootstrap-editable.css')}}" rel="stylesheet" type="text/css" />
