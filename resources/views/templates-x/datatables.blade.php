...
<html>
    <head>
        ...
        <link href="{{ asset('libs/prettify/github.css')}}" rel="stylesheet" />
                ...
                <link href="{{ asset('libs/jquery-datatables/css/dataTables.bootstrap.css')}}" rel="stylesheet" type="text/css" />
                <link href="{{ asset('libs/jquery-datatables/extensions/TableTools/css/dataTables.tableTools.css')}}" rel="stylesheet" type="text/css" />
...
<!-- Top Bar End -->
            ...
            <div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2><strong>Footer</strong> Callback</h2>
								<div class="additional-btn">
									<a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
									<a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
									<a href="#" class="widget-close"><i class="icon-cancel-3"></i></a>
	...
	<script src="{{ asset('libs/jquery-datatables/js/jquery.dataTables.min.js')}}"></script>
	<script src="{{ asset('libs/jquery-datatables/js/dataTables.bootstrap.js')}}"></script>
	<script src="{{ asset('libs/jquery-datatables/extensions/TableTools/js/dataTables.tableTools.min.js')}}"></script>
